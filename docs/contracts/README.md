...
Java source and test classes are validated by Maven Checkstyle. New and modified code must use meaningful, domain-oriented names; unexplained abbreviations and single-letter variables are not allowed.
